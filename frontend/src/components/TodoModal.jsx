...
function TodoModal({ data, open, cancelAction, changeTodoStatus, setTodos }) {
    ...
    >
      ...
      <div className="fixed overflow-y-auto inset-0 z-10 w-screen h-screen">
        ...
        >
          ...
          >
            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 min-h-52 overflow-x-auto">
              <div className="todoBase mt-3 mx-1 text-center sm:mt-0 sm:text-left">
                <h3
                  className="text-base lg:text-xl font-semibold leading-6 text-gray-900"
                  id="modal-title"
                >
                  {data.title || "Untitled"}
                </h3>
                <div className="my-2">
                  <p className="text-sm text-gray-500 whitespace-nowrap inline-block me-5 py-2 pr-2">{todoDescription}</p>
                </div>
                <div className="flex">
                  <button
                    type="button"
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      document.querySelector(".todoBase h3").innerText = data.title;
                      document.querySelector(".todoBase p").contentEditable = false;
                      document.querySelector(".todoBase p").innerText = data.description;
                      document.querySelector("#editTodo").style.display = "";
                      document.querySelector("#saveEditTodo").style.display = "none";
                      document.querySelector("#cancelEditTodo").style.display = "none";
                    }}
